#include "systemc.h"
//const int packet= 110101011;
SC_MODULE(server_mobile)
{
	sc_inout <bool> network_busy;
	sc_inout < sc_bigint <74> > physical_packet_out;
	sc_in <bool> clk;
	...
	sc_out < sc_bigint<1> > transmission_complete;
	sc_in  < sc_bigint<74> > counter;
	...
	sc_bigint<1>   temp_transmission_complete;
	sc_bigint<74>  temp_counter;
